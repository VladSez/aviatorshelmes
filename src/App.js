...
function App() {
  ...
  const backgroundImagePath = require(`./img/${(count + 1 < 11) ? count + 1 : 1}.png`);
      ...
      <div className="question_container">
        ...
        <div className="logo_arts">
          ...
          <div className="all_info">
            <i className="main_photo" style={{ backgroundImage: `url(${backgroundImagePath})` }} />
          </div>
        </div>
  ...
  if (answerValue <= 5) {
    ...
    finalWords = 'Что ж, возможно эта эпоха не для тебя. Но поверь, после нашей вечеринки все изменится. Я уверен, если ты будешь следовать моим рекомендациям, ты будешь неотразим(а), и этот вечер запомнится тебе надолго! Придя домой, ты с упоением начнешь смотреть фильмы про авиацию. Главное начать!';
    ...
    finalWords = 'Ты любишь эпоху 30-х, и кое-что о ней слышал(а), но нет предела совершенству. Приглашаю тебя на мою вечеринку после нее ты наверняка будешь знать все об изысканных нарядах, старом кино и развлечениях!';
  } else if (answerValue > 20 && answerValue <= 30) {
    recommendations = sex === 'male'
      ? 'В это время популярны увлечения авиацией, автомобилями и спортом, именно поэтому в моде подтянутое спортивное телосложение, так что абсолютно не важно, ты достанешь фрак или же джинсы с черной водолазкой – все зависит от твоей подачи. На моей вечеринке никто не останется без внимания!'
    ...
    finalWords = 'Ты много помнишь о моем времени, но есть и над чем поработать. Приходи на вечеринку, которая состоится уже совсем скоро, и ты узнаешь гораздо больше! Вечер предстоит грандиозный!';
    ...
    finalWords = 'Ты словно жил(а) в то время! Ты знаешь все об элегантных нарядах, громких вечеринках и полетах. На нашей вечеринке ты будешь чувствовать себя более чем уверенно и сможешь помочь новичкам.';
  }
  return (
