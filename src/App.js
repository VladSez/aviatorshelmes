...
function App() {
  ...
  if (answerValue <= 5) {
    ...
    finalWords = sex === 'male'
      ? 'Ты любишь эпоху 30-х, и кое-что о ней слышал, но нет предела совершенству. Приглашаем тебя на нашу вечеринку! После нее ты наверняка будешь знать все об изысканных нарядах, старом кино и развлечениях!'
      : 'Ты любишь эпоху 30-х, и кое-что о ней слышалa, но нет предела совершенству. Приглашаем тебя на нашу вечеринку! После нее ты наверняка будешь знать все об изысканных нарядах, старом кино и развлечениях!';
